...
import {
  ...
  Activity, Sparkles, Crosshair, FileCheck, Swords, Calculator, Users2, BarChart3, Scale, GitBranch,
} from 'lucide-react'
...
const navItems = [
  ...
  { id: 'okrs', label: 'OKR Tracker', icon: Crosshair },
  ...
  { id: 'meetings', label: 'Meeting Notes', icon: FileCheck },
